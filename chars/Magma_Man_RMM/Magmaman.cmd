...
value = ifelse(power>=1000,3300,1410)
...
ignorehitpause = 0
value = ifelse(random<500,200+random%2*600,400)

[State -1, AI Normal Attacks 3]
type = ChangeState
triggerall = (roundstate = 2) && (AiLevel) && random <= (750 * (AiLevel ** 2 / 64.0))
trigger1 = stateno = 400 && movehit
value = ifelse(power<1000,220,ifelse(random<500,3200,3300))

[State -1, AI Normal Attacks 3b]
type = ChangeState
triggerall = (roundstate = 2) && (AiLevel) && random <= (750 * (AiLevel ** 2 / 64.0))
...
trigger1 = (stateno = 640)
trigger1 = (prevstateno = 610)
value = ifelse(random>500,650,1410)
...
trigger1 = Power >= 1000 && !NumHelper(3410)
...
;---------------------------------------------------------------HYPER ATTACKS--------------------------------------------------------------------
[State -1, Upper Inferno]
type = ChangeState
value = 3200;ifelse(Statetype = A,3205,3200)
triggerall = (roundstate = 2) && (!AiLevel)
...
[State -1, Hear Tornado];Bubble Buster
type = ChangeState
value = 1204
triggerall = (roundstate = 2) && (!AiLevel)
...
value = 1206
triggerall = (roundstate = 2) && (!AiLevel)
triggerall = var(35) = 5 && !NumHelper(12060) && !NumHelper(12070) && !NumHelper(12080)
triggerall = (command = "QCFa") || (command = "QCFb") || (command = "QCFc")
trigger1 = Statetype != A  && ctrl
trigger2 = (HitdefAttr = SC, NA) && (MoveContact)
...
trigger1 = (StateType = S) && (Ctrl)
trigger2 = (StateNo = 230) && (Movecontact) && (PrevStateno != 200)
...
[State -1, A]
type = ChangeState
value = 230;ifelse (numhelper(6024) >= 1,250,230)
triggerall = (roundstate = 2) && (!AiLevel)
...
type = ChangeState
triggerall = !AiLevel 
trigger1 =  movehit && stateno = [600,650]
trigger1 = command = "Up"
value = 45
ctrl = 1
