...
[State -1, Anti Air]
type = changestate
Triggerall = roundstate = 2 && (AiLevel) && random < (800 * (AIlevel ** 2 / 64.0)) && ctrl && NumHelper(9010) = 0
trigger1 = prevstateno != [1410,1411]
...
value = ifelse(random<50,1600,ifelse(random>900,700,130))
...
[State -1, AI Normal Attacks]
type = ChangeState
triggerall = (roundstate = 2) && random < (800 * (AIlevel ** 2 / 64.0)) && (AiLevel)
triggerall = (Ctrl) && (statetype = S) && (EnemyNear,Statetype !=L)
trigger1 = (p2bodydist X <= 25) && stateno != 200
ignorehitpause = 0
value = ifelse(random<500,200+random%2*600,ifelse(random<250,440,800+random%2))
...
[State -1, AI Hyper]
type = ChangeState
triggerall = (roundstate = 2) && random < (800 * (AIlevel ** 2 / 64.0)) && (AiLevel) && Power >=1000
triggerall =StateType !=A
...
trigger2 = time > 6
value = ifelse(power<1000,420,ifelse(random<500,3100,3300))
...
[State -1, JLP / JLK]
type = changestate
Triggerall = roundstate = 2 && (AiLevel) && random < (800 * (AIlevel ** 2 / 64.0)) && (statetype = A) && NumHelper(9010) = 0
triggerall = (time > 4) && ctrl && prevstateno != [620,650]
triggerall = prevstateno != 5040
trigger1 = stateno = 50; && EnemyNear, Pos X <=100  && EnemyNear, Pos Y <0
trigger2 = stateno = 7001; && EnemyNear, Pos X <=100  && EnemyNear, Pos Y <0
value = ifelse((p2bodydist X <=50),600,ifelse(NumHelper(2210),1410,1500));ifelse (random <=500,600,630)
...
[State -1, 2]
type = changestate
Triggerall = roundstate = 2 && (AiLevel) && random < (800 * (AIlevel ** 2 / 64.0)) && (statetype = A)
...
value = ifelse(power>=1000,3000,ifelse(random>500,620,1410))
ignorehitpause = 1
...
value = ifelse(random<500,1000,1500+random%2*100)

[State -1, AI Special]
type = changestate
triggerall = (roundstate = 2) && (AiLevel)
triggerall = stateno != [1400,1403]
trigger1 = (Ctrl) && (Statetype !=A) && random < (50 * (AIlevel ** 2 / 64.0))
value = 1400
...
triggerall = power >= 1000  && stateno != [1410,1411]
triggerall = Statetype !=A
trigger1 = ctrl
trigger2 = stateno < 3000 && (MoveContact)
...
[State -1, Mirror Buster]
type = ChangeState
value = 1600;ifelse(statetype = A,1550,1500)
triggerall = (roundstate = 2) && (!AiLevel) 
triggerall = stateno != [3000,3999]
triggerall = stateno!= 1600 && NumHelper(2250)=0 && NumHelper(2210)=0 && Statetype != A
...
[State -1, Drop Spike]
type = ChangeState
value = 1500;ifelse(statetype = A,1550,1500)
triggerall = (roundstate = 2) && (!AiLevel) 
triggerall = stateno != [3000,3999]
...
trigger2 = (StateType != C) && (HitdefAttr = SA, NA) && (MoveContact)
...
type = ChangeState
value = 855
triggerall = AiLevel && random < (800 * (AIlevel ** 2 / 64.0)) && alive=1
triggerall = Var(30) = 5
trigger1 = (Pos Y >= 0) && (Vel Y > 0)
